...
SYSTEM_INSTRUCTION = (
    ...
    "- Cuando busques una persona, usa buscar_por_persona con solo los APELLIDOS primero. "
    "Los nombres en SECOP pueden tener variaciones ortograficas (ej: JOHANA vs JHOANA, STEVEN vs STEPHEN). "
    "Buscar por apellidos es mucho mas confiable.\n"
    "- Ejemplo: para 'Kelly Johana Quilcue Vivas', busca con nombre='QUILCUE VIVAS'.\n"
    "- Si encuentras resultados, puedes obtener el numero de documento y hacer una segunda busqueda "
    "con buscar_por_persona(documento=...) para tener resultados exactos.\n\n"
