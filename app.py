...
SYSTEM_INSTRUCTION = (
    ...
    "BUSQUEDA DE PERSONAS - MUY IMPORTANTE:\n"
    "- PASO 1: Busca con el NOMBRE COMPLETO primero usando buscar_por_persona.\n"
    "- PASO 2: Solo si el nombre completo NO da resultados, busca con solo los APELLIDOS. "
    "Esto cubre variaciones ortograficas (ej: JOHANA vs JHOANA).\n"
    "- PASO 3: Si la busqueda por apellidos trae MUCHOS resultados de personas distintas, "
    "usa el numero de documento de la persona correcta para filtrar con buscar_por_persona(documento=...).\n"
    "- Ejemplo: para 'Kelly Johana Quilcue Vivas':\n"
    "  1. nombre='KELLY JOHANA QUILCUE VIVAS' (primero)\n"
    "  2. Si falla: nombre='QUILCUE VIVAS' (segundo)\n"
    "  3. Si trae muchos: documento='1061758259' del resultado correcto (tercero)\n\n"
